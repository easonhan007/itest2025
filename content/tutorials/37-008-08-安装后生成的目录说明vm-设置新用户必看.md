---
weight: 8
title: 08. 安装后生成的目录说明、VM 设置（新用户必看）
date: '2017-10-16T05:00:11+08:00'
...
![安装目录介绍](http://img.testclass.net/viii-a-installation-directory-1.jpg)
...
![设置目录介绍](http://img.testclass.net/viii-a-installation-directory-2.jpg)
...
![JVM 配置说明](http://img.testclass.net/viii-a-configuration-files-1.jpg)
...
![JVM 配置说明](http://img.testclass.net/viii-a-configuration-files-2.jpg)
...
![JVM 配置说明](http://img.testclass.net/viii-a-setting-synchronize-1.jpg)

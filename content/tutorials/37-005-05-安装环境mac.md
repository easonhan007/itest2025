...
resources:
- name: featured-image
  src: https://images.unsplash.com/photo-1516259762381-22954d7d3ad2?w=300
tags: []
categories:
- IntelliJ IDEA简明教程
lightgallery: true
...
![Mac 下安装过程](http://img.testclass.net/v-a-mac-install-1.jpg)
> * 运行下载到 `ideaIU-14.1.4.dmg`，效果如上图所示。
> * 根据提示把左侧的 IntelliJ IDEA 图标拖动到右侧目录图

![Mac 下安装过程](http://img.testclass.net/v-a-mac-install-2.jpg)
> * 拖动完成之后即可在 `应用程序` 中看到 IntelliJ IDEA 的启动图标，点击运行即可。

## Mac 修改运行 JDK 版本

![Mac 下安装过程](http://img.testclass.net/v-a-mac-install-3.jpg)
...
![课程图片](https://images.unsplash.com/photo-1516259762381-22954d7d3ad2?w=300)

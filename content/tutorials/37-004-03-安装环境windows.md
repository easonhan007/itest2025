...
resources:
- name: featured-image
  src: https://images.unsplash.com/photo-1653179241439-c4c10083879a?w=300
tags: []
categories:
- IntelliJ IDEA简明教程
lightgallery: true
...
![首次安装步骤截图](http://img.testclass.net/iii-a-first-install-1.jpg)

![首次安装步骤截图](http://img.testclass.net/iii-a-first-install-2.jpg)

![首次安装步骤截图](http://img.testclass.net/iii-a-first-install-3.jpg)

![首次安装步骤截图](http://img.testclass.net/iii-a-first-install-4.jpg)
...
![首次安装步骤截图](http://img.testclass.net/iii-a-first-install-5.jpg)

![首次安装步骤截图](http://img.testclass.net/iii-a-first-install-6.jpg)

![首次安装步骤截图](http://img.testclass.net/iii-a-first-install-7.jpg)

> * 整个安装过程，一般的配置电脑安装所需的时间大约是 1 ~ 5 分钟。

## 已有旧版本安装新版本

![已有旧版本安装新版本步骤截图](http://img.testclass.net/iii-b-repeatedly-install-1.jpg)

![已有旧版本安装新版本步骤截图](http://img.testclass.net/iii-b-repeatedly-install-2.jpg)
...
![已有旧版本安装新版本步骤截图](http://img.testclass.net/iii-b-repeatedly-install-3.jpg)
...
![卸载](http://img.testclass.net/iii-c-uninstall-1.jpg)

![卸载](http://img.testclass.net/iii-c-uninstall-2.jpg)

![卸载](http://img.testclass.net/iii-c-uninstall-3.jpg)
...
![课程图片](https://images.unsplash.com/photo-1653179241439-c4c10083879a?w=300)

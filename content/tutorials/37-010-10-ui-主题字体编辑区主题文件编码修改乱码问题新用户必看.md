---
weight: 10
title: 10. UI 主题、字体、编辑区主题、文件编码修改、乱码问题（新用户必看）
date: '2017-10-16T03:00:11+08:00'
...
resources:
- name: featured-image
  src: https://images.unsplash.com/photo-1625459201773-9b2386f53ca2?w=300
tags: []
categories:
- IntelliJ IDEA简明教程
lightgallery: true
...
![主题修改](http://img.testclass.net/x-a-theme-setting-1.jpg)
...
![主题字体修改](http://img.testclass.net/x-b-font-setting-1.jpg)
...
![代码编辑字体修改](http://img.testclass.net/x-b-font-setting-2.jpg)
...
![控制台输出字体修改](http://img.testclass.net/x-b-font-setting-3.jpg)
...
![编辑区主题介绍](http://img.testclass.net/x-c-code-theme-setting-1.jpg)
...
![编辑区主题细节修改](http://img.testclass.net/x-c-code-theme-setting-2.jpg)
...
![文件编码修改](http://img.testclass.net/x-d-encoding-setting-1.jpg)
...
![文件编码修改](http://img.testclass.net/x-d-encoding-setting-2.gif)
...
![Tomcat 控制台输出乱码](http://img.testclass.net/x-e-encoding-setting-1.jpg)
...
![课程图片](https://images.unsplash.com/photo-1625459201773-9b2386f53ca2?w=300)

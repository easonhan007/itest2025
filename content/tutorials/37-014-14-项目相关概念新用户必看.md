---
weight: 14
title: 14. 项目相关概念（新用户必看）
date: '2017-10-15T23:00:11+08:00'
...
![Project 和 Module 介绍](http://img.testclass.net/xiv-a-project-and-module-introduce-1.gif)
...
![SDK 介绍](http://img.testclass.net/xiv-b-sdk-introduce-1.jpg)
...
![SDK 介绍](http://img.testclass.net/xiv-b-sdk-introduce-2.jpg)
...
![language level 介绍](http://img.testclass.net/xiv-c-language-level-introduce-1.jpg)

![language level 介绍](http://img.testclass.net/xiv-c-language-level-introduce-2.jpg)
...
![Module 下的 SDK 和 language level](http://img.testclass.net/xiv-d-module-setting-1.jpg)

> * 如上图标注 1 所示，可以针对 Module 选择其他 SDK，默认选择的是 `Project SDK`

![Module 下的 SDK 和 language level](http://img.testclass.net/xiv-d-module-setting-2.jpg)
...
![课程图片](https://images.unsplash.com/photo-1487058792275-0ad4aaf24ca7?w=300)
